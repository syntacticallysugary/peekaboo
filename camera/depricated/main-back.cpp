...
// LED pin for testing (flashlight on GPIO 4 works on this board)
#define LED_PIN 4
...
void setup() {
    Serial.begin(115200);
    Serial.println("Peak-a-Boo ESP32-CAM Pusher starting...");
    ...
    // Frame size and quality for PSRAM usage
    if (psramFound()) {
...
void loop() {
    ...
    // Wait 200ms before next capture
    delay(200);
}