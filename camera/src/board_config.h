...
#ifndef BOARD_TYPE
    #error "BOARD_TYPE must be defined via build flags (e.g., -D BOARD_TYPE=2 for ESP32-S3-SPY, -D BOARD_TYPE=3 for ESP32-S3-EYE)"
#endif
...
#if BOARD_TYPE == BOARD_ESP32S3SPY
...
#else
    #error "Unknown BOARD_TYPE. Must be 2 (ESP32-S3-SPY) or 3 (ESP32-S3-EYE)"
#endif
